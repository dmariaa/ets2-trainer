...
class RandomChannelSwap(object):
    ...
    def __call__(self, sample):
        ...
        # if not _is_pil_image(depth): raise TypeError('depth should be PIL Image. Got {}'.format(type(depth)))
